    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audit_password', models.CharField(default='audit2025', help_text='Password for audit trail access', max_length=100)),
                ('audit_access_code', models.CharField(default='AUDIT-EESA-2025', help_text='Special access code for audit trail', max_length=50)),
                ('voting_start_time', models.DateTimeField(blank=True, help_text='Global voting start time for all positions', null=True)),
                ('voting_end_time', models.DateTimeField(blank=True, help_text='Global voting end time for all positions', null=True)),
